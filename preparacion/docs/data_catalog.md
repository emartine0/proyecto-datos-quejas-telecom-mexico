...
|	fecha_ingreso         | DATE          | Fecha en que el expediente fue registrado. Con formato YYYY-MM-DD (2022-05-04)                                          |
|	fecha_cierre          | DATE          | Fecha de conclusión administrativa del expediente. Puede ser nula si sigue abierto. Con formato YYYY-MM-DD (2022-05-04) |
...
|	monto_reclamado       | FLOAT         | Indica el valor monetario total que la persona consumidora reclama o solicita recuperar en el expediente, expresado en moneda nacional (pesos mexicanos, MXN). |
|	monto_recuperado      | FLOAT         | Indica el importe total que la persona consumidora recuperó a su favor como resultado del proceso conciliatorio o de la gestión de PROFECO, expresado en moneda nacional (pesos mexicanos, MXN). |
...
|	costo_bien_servicio   | FLOAT         | Indica el importe total del bien o servicio adquirido que dio origen a la queja o expediente, expresado en moneda nacional (pesos mexicanos, MXN).  |
